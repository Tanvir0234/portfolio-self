    ...
    return (
        <div className=" bg-dark my-5" id="about">
            ...
            <div className="row py-5">
                ...
                <div className="col-lg-6 col-sm-12 about-content mx-auto">
                        ...
                        <div>
                            ...
                            <a className=" my-2 p-2 bg-success text-white"  href="https://www.linkedin.com/in/md-tanvir-ali-899830217/"><FaLinkedinIn></FaLinkedinIn></a>
                        </div>
                 </div>
            </div>
        </div>
